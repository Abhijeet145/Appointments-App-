...
const AddAppointment = ({onSendAppointment,lastId}) => {
  ...
  function formDataSubmit(){
    ...
    return (
        <div>
        <button className={`bg-blue-400 text-white px-2 py-3 w-full text-left ${toggleForm ? `rounded-t-md`:`rounded-md`}`}
        onClick={()=>{
          setToggleForm(!toggleForm);
        }}
        >
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input type="text" name="ownerName" id="ownerName"
                ...
                className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-2xl border-gray-300 rounded-md" />
            </div>
          </div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              ...
              value={formData.aptNotes}
                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-2xl border-gray-300 rounded-md" placeholder="Detailed comments about the condition"></textarea>
            </div>
          </div>
